...
public class JZombiesBuilder implements ContextBuilder<Object> {
	...
	public Context build(Context<Object> context) {
		...
		NetworkBuilder<Object> netBuilder= new NetworkBuilder<Object> ("Mushroom network", context, true);
		...
		// This for iterates through all the agents, retrieves each one's location in the
		// continuousSpace and moves it to the corresponding location in the Grid.
